//=============================================================================
// RPG Maker MZ - SumRndmDde Shaking Text
//=============================================================================

/*:
 * @target MZ
 * @plugindesc Allows you to add Shaking Text to your Show Text events!
 * @author SumRndmDde (Ported by CT_Bolt)
 * 
...
var SRD = SRD || {};
SRD.ShakingTextMZ = SRD.ShakingTextMZ || {};

var Imported = Imported || {};
Imported["SumRndmDde Shaking Text"] = 1.13;

(($_$) => {
    const NAMESPACE   = 'ShakingTextMZ';
    const PLUGIN_NAME = 'SRD_' + NAMESPACE;
	var $ = {};
	function getPluginParameters() {var a = document.currentScript || (function() { var b = document.getElementsByTagName('script'); return b[b.length - 1]; })(); return PluginManager.parameters(a.src.substring((a.src.lastIndexOf('/') + 1), a.src.indexOf('.js')));} $.params = getPluginParameters();
	...
	Window_Message.prototype.processEscapeCharacter = function(code, textState) {
		...
		case 'SHAKE':
			...
			break;
		case 'WAVE':
			var info = String(this.obtainShakingTextMZParams(textState)).match(/(.+)\s*,\s*(.+)/);
